...
*** IP Addresses --- A Little Context
    ...
    The rules are a fundamental part of the TCP/IP protocol system; you need to
    understand IP addressing in order to understand TCP/IP.  The details of
...
**** IPv4 Addressing System
    ...
    The most common version of IP is IPv4.  This secttion teaches about the
    IPv4 addressing system.  It also teaches how TCP/IP delivers datagrams on a
